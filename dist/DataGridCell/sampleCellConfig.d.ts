...
export declare const sampleRowContainsSubTitle: {
    'subTitle-baseColumn': string;
    'subTitle-iconEndColumn': string;
    'subTitle-avatarColumn': string;
    'subTitle-iconStartColumn': string;
    'subTitle-endActionColumn': string;
    'subTitle-all': string;
    id: string;
    baseColumn: string;
    iconEndColumn: string;
