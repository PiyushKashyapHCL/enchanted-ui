...
const image_1 = __importDefault(require("@enchanted-prod/material-ui-icons/dist/carbon/es/image"));
const folder_1 = __importDefault(require("@enchanted-prod/material-ui-icons/dist/carbon/es/folder"));
const folders_1 = __importDefault(require("@enchanted-prod/material-ui-icons/dist/carbon/es/folders"));
const error_1 = __importDefault(require("@enchanted-prod/material-ui-icons/dist/carbon/es/error"));
const retry__failed_1 = __importDefault(require("@enchanted-prod/material-ui-icons/dist/carbon/es/retry--failed"));
const video_1 = __importDefault(require("@enchanted-prod/material-ui-icons/dist/carbon/es/video"));
const DOC_1 = __importDefault(require("@enchanted-prod/material-ui-icons/dist/carbon/es/DOC"));
const XLS_1 = __importDefault(require("@enchanted-prod/material-ui-icons/dist/carbon/es/XLS"));
const PDF_1 = __importDefault(require("@enchanted-prod/material-ui-icons/dist/carbon/es/PDF"));
const PPT_1 = __importDefault(require("@enchanted-prod/material-ui-icons/dist/carbon/es/PPT"));
const TIF_1 = __importDefault(require("@enchanted-prod/material-ui-icons/dist/carbon/es/TIF"));
const GIF_1 = __importDefault(require("@enchanted-prod/material-ui-icons/dist/carbon/es/GIF"));
const SVG_1 = __importDefault(require("@enchanted-prod/material-ui-icons/dist/carbon/es/SVG"));
const JPG_1 = __importDefault(require("@enchanted-prod/material-ui-icons/dist/carbon/es/JPG"));
const PNG_1 = __importDefault(require("@enchanted-prod/material-ui-icons/dist/carbon/es/PNG"));
